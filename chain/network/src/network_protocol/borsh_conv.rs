...
impl TryFrom<&net::HandshakeFailureReason> for mem::HandshakeFailureReason {
    ...
    fn try_from(x:&net::HandshakeFailureReason) -> anyhow::Result<Self> {
        Ok(match x {
            net::HandshakeFailureReason::ProtocolVersionMismatch{version,oldest_supported_version} => 
               mem::HandshakeFailureReason::ProtocolVersionMismatch{version:*version,oldest_supported_version:*oldest_supported_version},
            net::HandshakeFailureReason::GenesisMismatch(genesis_id) => mem::HandshakeFailureReason::GenesisMismatch(genesis_id.clone()),
            net::HandshakeFailureReason::InvalidTarget => mem::HandshakeFailureReason::InvalidTarget,
        })
    }
}
...
impl TryFrom<&net::PeerMessage> for mem::PeerMessage {
    ...
    fn try_from(x:&net::PeerMessage) -> anyhow::Result<Self> {
        Ok(match x.clone() {
            ...
            net::PeerMessage::HandshakeFailure(pi,hfr) => mem::PeerMessage::HandshakeFailure(pi,(&hfr).try_into()?),
            ...
            net::PeerMessage::BlockHeadersRequest(bhs) => mem::PeerMessage::BlockHeadersRequest(bhs),
            ...
            net::PeerMessage::EpochSyncRequest(epoch_id) => mem::PeerMessage::EpochSyncRequest(epoch_id),
...
impl TryFrom<&mem::PeerMessage> for net::PeerMessage {
    ...
    fn try_from(x:&mem::PeerMessage) -> anyhow::Result<Self> {
        Ok(match x.clone() {
            ...
            mem::PeerMessage::HandshakeFailure(pi,hfr) => net::PeerMessage::HandshakeFailure(pi,(&hfr).try_into()?),
            ...
            mem::PeerMessage::BlockHeadersRequest(bhs) => net::PeerMessage::BlockHeadersRequest(bhs),
            ...
            mem::PeerMessage::EpochSyncRequest(epoch_id) => net::PeerMessage::EpochSyncRequest(epoch_id),
            mem::PeerMessage::EpochSyncResponse(esr) => net::PeerMessage::EpochSyncResponse(esr),
            mem::PeerMessage::EpochSyncFinalizationRequest(epoch_id) => net::PeerMessage::EpochSyncFinalizationRequest(epoch_id),
            mem::PeerMessage::EpochSyncFinalizationResponse(esfr) => net::PeerMessage::EpochSyncFinalizationResponse(esfr),
